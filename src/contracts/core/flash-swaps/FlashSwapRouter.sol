    ...
    IUniswapV2Callee
{
    ...
    function _swapRaforDs(
        ...
        // amount out its ds tokens user will reveive, borrowed is borrowed Ra ammount
        ...
        // reserve in that case is the routerstate ds balance it sells
        ...
        // @audit - M true param should be false as user is trying to sell ds not buy
        // right?
        __flashSwap(
            assetPair,
            assetPair.pair,
    ...
    // referenced in docs as buying ds
    /**
    ...
    function swapRaforDs(
        ...
        IERC20(assetPair.ra).safeTransferFrom(
            msg.sender,
            address(this),
            amount
        );

        amountOut = _swapRaforDs(
            self,
            assetPair,
            reserveId,
            dsId,
    ...
    function previewSwapRaforDs(
        ...
        if (amountSellFromReserve != 0) {
            ...
            // @audit overflow error here! see why exactly is that
    ...
    // @audit - referenced in docs as sell Ds to amm
    /**
    ...
    function __swapDsforRa(
        ...
        // @audit ok here happens overflow - under
        console.log("aqui");
        ...
        // @audit param false should be true right?
        __flashSwap(
            assetPair,
            assetPair.pair,
            0,
    ...
    function __flashSwap(
        ...
        // it triggers a swap in unisswap with data, then it executes uniswapV2Call
        // that basically calls __afterFlashswapBuy
        // ra is token0 ct is token1
        univ2Pair.swap(amount0out, amount1out, address(this), data);
    }

    // @audit function called by uniswap on flashSwap?
    ...
    function __afterFlashswapBuy(
        ...
        // repay flash loan - here msg.sender ins Uniswap
    ...
    function __afterFlashswapSell(
        ...
        // repay flash loan here msg sender is uni
