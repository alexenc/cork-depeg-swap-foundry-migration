...
library DsFlashSwaplibrary {
    ...
    // @audit check logic and math here
    function getPriceRatio(
        ...
        // @audit - q i think this is a external call to get reserves of uniV2 amm
        // that performs a external call to univs ct - ra amm ceck for some kind of pool attacks on
        // initialize
    ...
    function addReserve(
        ...
        // @audit - gas could cache value used twice
        self.ds[dsId].reserve += amount;
        reserve = self.ds[dsId].reserve;
    }
    ...
    function getAmountOutSellDS(
        ...
        console.log(amount, repaymentAmount, "here occurs underflow");
        ...
        )
    {
        ...
        // amountout its ds user will receive and borrowed its ra that will be borrowed from amm
